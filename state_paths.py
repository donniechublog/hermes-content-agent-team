...
LOGO_SUFFIX = ".logo.png"          # LOW-295: ban da dung thanh slide logo (90% be ngang)
...
REPORT_HISTORY_FILE = "report_history.{}.jsonl"        # .format(role): {message_ids, manifest, ts} moi bao cao da gui, LOW-362
REPICK_PENDING_FILE = "repick_pending.json"            # cau hoi "lam lai tin da giao?" dang cho nut, LOW-362
