...
Cả 23 profile chạy chính bằng `ag/gemini-3.8-flash` qua 9router, dự phòng
xai/grok-4.6 rồi gcli/grok-4.6 (trước 22/09/2026 là combo DS-v4Flash). `agent.reasoning_effort`
