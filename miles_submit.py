#!/usr/bin/env python3
"""miles_submit.py — NOP caption cua Miles: chuan hoa, do, cong chan, ghep draft, day
...
Dung:
    venv/bin/python miles_submit.py <draft_id>
    venv/bin/python miles_submit.py <draft_id> --khong-push     # thu: chi kiem + ghi draft thu
"""
import json
import argparse
import re
