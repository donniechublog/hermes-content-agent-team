...
trong itachi_submit.py; retouch/blend/nền AI chờ GPU (CPU quá nặng), đợt tới bật.

Dùng:
    venv/bin/python itachi_prepare.py 338            # một slide
    venv/bin/python itachi_prepare.py 336 338 340    # nhiều slide (id đầu là khoá bộ)
"""
import argparse
import json
import sys
...
def prepare_slide(id_: str) -> dict:
