...
bài báo VỀ TSMC, không phải bài cùng tin. Xem docstring anh_bao_thuc_the.py.
...
import anh_bao_thuc_the as bt                                 # noqa: E402
...
def test_link_bing_rss_giai_ra_url_that():
    ...
    assert bt.link_that(l) == "https://247wallst.com/investing/2026/09/11/tsmc-x/"
    assert bt.link_that("https://a.com/b") == "https://a.com/b"
    assert bt.link_that("") == ""
...
def test_loc_bai_bo_trung_bo_tong_hop_toi_da_moi_mien():
    ...
    assert bt.loc_bai(items, bo_mien=("engadget.com",))[-1]["mien"] == "247wallst.com"


def test_og_tu_html_hai_thu_tu_thuoc_tinh_va_twitter():
    assert bt.og_tu_html('<meta property="og:image" content="https://c/x.jpg">', "https://a/b") == "https://c/x.jpg"
    assert bt.og_tu_html('<meta content="https://c/y.jpg" property="og:image"/>', "https://a/b") == "https://c/y.jpg"
    assert bt.og_tu_html('<meta name="twitter:image" content="/img/z.jpg">', "https://a/b/c") == "https://a/img/z.jpg"
    assert bt.og_tu_html("<html></html>", "https://a") is None
...
def test_tim_anh_them_goi_nguon_nay():
    src = (ROOT / "tim_anh_them.py").read_text(encoding="utf-8")
    assert "anh_bao_thuc_the.anh_bao_thuc_the(" in src
