...
- Bìa (`build_cover`) giữ bố cục đã duyệt. Thẻ Ethan đi luật riêng từ LOW-343 (vùng chữ
  màu trơn, `IMAGE_RULES_ETHAN.md`); slide Kite chưa kiểm theo luật này (LOW-287).
...
- Slide Kite: `render_edu.py` đã có nhánh nền phẳng (lấp màu nền, đổi màu chữ) từ
  ...
  đi luật riêng từ LOW-343 (vùng chữ một màu trơn lấy từ nền ảnh).
