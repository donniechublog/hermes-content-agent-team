...
BOARD = (
    # --- 7 bang arena.ai -----------------------------------------------------
    Board("text", "van ban", "VAN BAN (arena.ai)", ARENA + "text", "arena", "text"),
    Board("webdev", "webdev", "CODE WEBDEV (arena.ai)", ARENA + "code/webdev",
         "arena", "code/webdev"),
    Board("vision", "vision", "VISION (arena.ai)", ARENA + "vision", "arena", "vision"),
    Board("search", "search", "SEARCH (arena.ai)", ARENA + "search", "arena", "search"),
    Board("image", "tao anh", "TAO ANH (arena.ai)", ARENA + "text-to-image",
         "arena", "text-to-image"),
    Board("image_edit", "sua anh", "SUA ANH (arena.ai)", ARENA + "image-edit",
         "arena", "image-edit"),
    ...
    Board("swebench", "SWE-bench", "SWE-BENCH VERIFIED (moi he thong agent)",
         SWE, "top", diem_hau="%"),
    ...
    Board("stt", "nghe chep", "NGHE CHEP — STT (artificialanalysis, do chinh xac)",
