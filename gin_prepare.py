#!/usr/bin/env python3
"""gin_prepare.py — BRIEF cho Gin (dọn chữ trên ảnh nền): OCR định vị vùng chữ,
đánh số, đo màu chữ, vẽ preview — KHÔNG xoá gì (LaMa chạy ở gin_submit.py).
...
giữ (theo text, không cần nhìn ảnh) rồi chạy gin_submit.py.
...
def find_image(dau_vao: str) -> tuple:
