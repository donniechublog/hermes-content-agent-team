#!/usr/bin/env python3
"""kiem_moi_truong.py -- chan dau truoc khi cho engine chay: co du cv2, model
...
TEN_MODEL_YUNET = "face_detection_yunet_2023mar.onnx"
...
def kiem_bien_moi_truong(ten: str, ghi_chu: str = "") -> tuple:
...
MUC_KIEM = [
    ("cv2 (opencv)", kiem_cv2),
    ("model YuNet (luat_anh)", kiem_yunet),
    ("Playwright + Chromium", kiem_chromium),
    ("OPENAI_API_KEY", kiem_openai_key),
    ("TELEGRAM_BOT_TOKEN", kiem_telegram_token),
]
