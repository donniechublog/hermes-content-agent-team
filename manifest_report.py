...
tin nhan, con Nova va Vera dung manifest_write.py. Moi noi mot kieu, va cho nao
...
def use(items: list, vai: str, ngay: str = None, tieu_de_phu: str = "") -> str:
    """Tra ve ban bao cao HTML danh so, san sang gui bang publish.py --file."""
    ten = NAME_ROLE.get(vai, vai)
