#!/usr/bin/env python3
"""gin_submit.py — NỘP của Gin: xoá chữ bằng LaMa theo vùng OCR (trừ vùng `giu`),
...
Dùng:
    venv/bin/python gin_submit.py 338                 # xoá hết vùng chữ, gửi
...
def main() -> int:
    ...
    ap.add_argument("id", help="message_id (đã chạy gin_prepare.py)")
    ...
    nen, mask_dbg, vung_json, so_xoa, so_giu = single(a.id, wd, spec)
