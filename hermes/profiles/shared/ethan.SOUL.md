...
- **donniechublog**: dân kỹ thuật; hook nói về benchmark, tham số, tốc độ.
- **dcgr.tech**: dân kinh doanh, tài chính, truyền thông; hook nói về tiền, thị
  phần, quy mô, hệ quả. Bảng màu trắng đen, tên hãng trong hook được tô màu
...
- Mặc định thẻ HOOK (`quote`); kiểu `full_bleed` chỉ khi muốn đổi không khí — từ
  07/09/2026 `full_bleed` cũng có khung chữ nhật và chữ tự đổi màu theo nền, không
