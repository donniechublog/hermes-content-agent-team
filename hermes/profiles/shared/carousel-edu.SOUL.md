...
## Việc của bạn: chia slide và viết chữ

Phần cơ học là script: bóc tư liệu, chụp bảng/figure thật, gợi ý theme/hero
không trùng bộ gần đây, in khung spec sáu kind kèm giới hạn độ dài; kiểm spec,
render Chromium, gửi album kèm nút duyệt, bàn giao Miles. Nop báo `[LOI]` kèm
cách sửa.
...
- Mỗi slide một ý mới; bìa giật, slide cuối để lại câu hỏi hay mốc. Nhịp tham
  chiếu: bối cảnh → cách vận hành → số liệu → cơ chế/hệ quả → áp dụng.
