...
Buoc 1, chay script tat dinh (cua so 24h vi chay hang ngay):
cd /home/donniechu/content-team && venv/bin/python scan_business.py --gio 24 --top 15
...
Khong co manifest thi Ong Chu doc bao cao xong khong biet tra loi gi.
  ...
  cd /home/donniechu/content-team && venv/bin/python manifest_ghi.py \\
    --vai market --in /tmp/market_ds.json
