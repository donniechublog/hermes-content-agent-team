...
# Chay bong tu chon tin (LOW-349): cham goi y "headline nay co duoc chon khong" cho tin quet
# moi, gui do trung voi lua chon cua Ong Chu vao topic Ada. Moi brand chay tren state/<brand>/
# va topic Ada cua minh.
