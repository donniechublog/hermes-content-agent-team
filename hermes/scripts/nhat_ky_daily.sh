...
#   - hai lenh nhat_ky.py khong ai xem ma thoat;
...
venv/bin/python nhat_ky.py --ngay "$HOM_QUA" >/dev/null || { echo "LOI: nhat_ky.py $HOM_QUA"; loi=1; }
venv/bin/python nhat_ky.py --ngay "$HOM_NAY" >/dev/null || { echo "LOI: nhat_ky.py $HOM_NAY"; loi=1; }
...
ma9=${PIPESTATUS[0]}
[ "$ma9" -eq 0 ] || { echo "LOI: theo_doi_9router.py $HOM_QUA (ma $ma9)"; loi=1; }
